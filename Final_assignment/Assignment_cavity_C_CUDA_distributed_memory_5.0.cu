...
//nx=41,ny=41,nt=10000, tsubame P100x1  1.315MLUPS, nvcc Assignment_cavity_C_CUDA_distributed_memory_5.0.cu -O3 -arch=sm_60 -Xcompiler "-march=native"   (module load gcc nvhpc)
